  ...
  define('bankName', 'CunLab',true);
   $note ="";
    ...
    { 
      ...
      $amount = $_POST['amount'];
      if(setOtherBalance($amount,'debit',$id))
    ...
    {
      setBalance($_POST['amount'],'debit',$_POST['id']);
    ...
    {
      setBalance($_POST['amount'],'credit',$_POST['id']);
...
<div class="row w-100" style="padding: 11px">
  ...
  <div class="card-body">
    ...
    $con = new mysqli('localhost','root','','CunLab');
      {
        $array2 = $con->query("select * from otheraccounts where id = '$_POST[otherNo]'");
        $array3 = $con->query("select * from otheraccounts where id = '$_POST[otherNo]'");
        {
