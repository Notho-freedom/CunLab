...
<div class="row w-100" >
  ...
  <h4 class="display-5">messages reçus</h4>
  <p  class="lead alert alert-warning"><b>dernier messages reçus:</b>
     ...
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item">
            <img class="d-block w-100" src="images/nature.jpg" alt="Second slide" style="max-height: 250px">
          </div>


          <div class="carousel-item">
            <img class="d-block w-100" src="images/logo.png" alt="Third slide" style="max-height: 250px">
          </div>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          ...
          <div class="card-body">
            <a href="accounts.php" class="btn btn-outline-success btn-block">Infos Compte</a>
          </div>
        </div>
      </div>
      <div class="col">
        ...
        <div class="card-body">
          <a href="transfer.php" class="btn btn-outline-success btn-block">Transfer d'argent</a>
         </div>
        </div>
      </div>
    </div>
    <div class="row" style="padding: 22px">
      ...
      <div class="col">
        ...
        <div class="card-body">
          <a href="feedback.php" class="btn btn-outline-primary btn-block">Administrateurs</a>
         </div>
        </div>
      </div>
    </div>
